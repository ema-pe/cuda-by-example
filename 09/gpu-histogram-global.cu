...
//
// This is the GPU version using only global memory atomics.
//
// There are two issues with this version:
//      1. It generates random input data in the host and then copies it to the
//      device.
//
//      2. There are too many concurrent access to the global histogram,
...
int main() {
    ...
    // Equivalent.
    //dim3 grid(prop.multiProcessorCount*2);
